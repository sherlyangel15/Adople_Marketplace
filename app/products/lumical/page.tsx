...
//   const product = products.find((p) => p.slug === "lumical")
...
export default function LumicalPage() {
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div>
          ...
          <h1 className="text-3xl md:text-5xl font-semibold text-pretty">
            Beautiful scheduling that converts
          </h1>
          <p className="mt-4 text-sm md:text-base opacity-90 max-w-prose">
            Beautiful scheduling pages, round‑robin availability, and advanced booking automation. 
            Turn every visitor into a booked appointment.
          </p>
...
function TrustBar() {
  return (
    <div className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
      ...
      <span>4.7/5 from 94 reviews</span>
    </div>
  )
}
...
function FeatureAndVideo({ theme }: { theme: "dark" | "light" }) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div>
        ...
        <ul className="mt-6 space-y-4">
          <li className="border rounded-lg p-4">
            <details open>
              <summary className="font-medium cursor-pointer">Customizable booking pages</summary>
              <p className="mt-2 text-sm text-muted-foreground">
                Create beautiful, branded scheduling pages that match your business and convert visitors into appointments.
              </p>
            </details>
          </li>
          <li className="border rounded-lg p-4">
            <details>
              <summary className="font-medium cursor-pointer">Round-robin scheduling</summary>
              <ul className="mt-2 list-disc pl-5 text-sm text-muted-foreground space-y-1">
                <li>Automatically distribute appointments across team members</li>
                <li>Balance workload and ensure fair distribution</li>
                <li>Customize rules for different appointment types</li>
              </ul>
            </details>
          </li>
          <li className="border rounded-lg p-4">
            <details>
              <summary className="font-medium cursor-pointer">Calendar integrations</summary>
              <p className="mt-2 text-sm text-muted-foreground">
                Sync with Google Calendar, Outlook, and other calendar platforms to avoid double bookings and conflicts.
              </p>
            </details>
          </li>
          <li className="border rounded-lg p-4">
            <details>
              <summary className="font-medium cursor-pointer">Automated reminders</summary>
              <p className="mt-2 text-sm text-muted-foreground">
                Send automated email and SMS reminders to reduce no-shows and improve appointment attendance rates.
              </p>
            </details>
          </li>
        </ul>
      ...
      >
        <img
          src="/project-management-tool.png"
          alt="Lumical screenshot"
...
function renderFeatureValue(name: string, t: { price: number; credits: number }) {
  switch (name) {
    case "Team members":
      return t.credits === 0 ? 3 : "Unlimited"
    case "Booking pages":
      return t.credits === 0 ? 5 : "Unlimited"
...
function StoryBlock({ theme }: { theme: "dark" | "light" }) {
  return (
    <section className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-[280px,1fr] gap-8">
      ...
      >
        <div className="text-sm">Founded May 15, 2023</div>
        <div className="mt-3 text-sm">Amsterdam, Netherlands</div>
        <div className="mt-3 text-sm">Team size: 12–25</div>
        <div className="mt-3 text-sm">Funding: Seed</div>
        <a className="mt-4 inline-block text-primary underline" href="#">
          lumical.com
        </a>
      </aside>
      <article>
        <h3 className="text-xl md:text-2xl font-semibold mb-3">Simplifying appointment scheduling</h3>
        <p className="text-muted-foreground">
          Lumical was created to solve the complex scheduling challenges that businesses face every day. 
          Our platform combines beautiful design with powerful automation to make booking appointments 
          effortless for both businesses and their customers. With seamless Google Calendar integration 
          and advanced round-robin capabilities, we help teams work more efficiently while providing 
          a superior booking experience.
        </p>
      </article>
    </section>
  )
...
function Testimonials({ theme }: { theme: "dark" | "light" }) {
  const items = [
    { title: "Reduced no-shows by 60%", name: "Emma Thompson", date: "Jul 2, 2025" },
    { title: "Beautiful booking experience", name: "Marcus Chen", date: "Jun 28, 2025" },
    { title: "Perfect for our consulting business", name: "Anna Rodriguez", date: "Jun 22, 2025" },
    { title: "Calendar sync works flawlessly", name: "James Wilson", date: "Jan 25, 2025" },
    { title: "Round-robin scheduling is brilliant", name: "Sarah Kim", date: "Feb 8, 2025" },
    { title: "Best scheduling tool we've used", name: "David Lee", date: "Feb 25, 2025" },
  ]
  return (
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {items.map((t, i) => (
          ...
          >
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              {i % 2
                ? "The automated reminders have dramatically improved our appointment attendance rates."
                : "Our clients love the beautiful booking pages and how easy it is to schedule appointments."}
            </p>
...
function StoriesYoullLove({ theme }: { theme: "dark" | "light" }) {
  const items = [
    { title: "How to Reduce No-Shows with Smart Scheduling", date: "Jul 5, 2025" },
    { title: "NEW FEATURE — Advanced Round-Robin Rules", date: "Jun 30, 2025" },
    { title: "The Complete Guide to Calendar Integration", date: "Apr 8, 2025" },
  ]
  return (
    <section className="max-w-7xl mx-auto px-4 py-12">
...
function InsiderKnowledge({ theme }: { theme: "dark" | "light" }) {
  const faqs = [
    "How do I set up my first booking page?",
    "Which calendars do you integrate with?",
    "Can I customize the booking form?",
    "How does round-robin scheduling work?",
    "Do you send automated reminders?",
    "Can I set different availability for team members?",
    "Do you support recurring appointments?",
        ...
        <div className="mt-6 space-y-3">
          {faqs.map((q, i) => (
            ...
            >
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                {i % 2
                  ? "Create a booking page in minutes with our step-by-step wizard and customizable templates."
                  : "We integrate with Google Calendar, Outlook, Apple Calendar, and most major calendar platforms."}
              </p>
            </details>
          ))}
        </div>
  ...
  return (
    <section className={cn("mt-6 py-14 text-center", theme === "dark" ? "bg-[#0a0d0b]" : "bg-neutral-950 text-white")}>
      <div className="max-w-3xl mx-auto px-4">
        <h3 className="text-xl md:text-2xl font-semibold">Start booking more appointments</h3>
        <p className="mt-2 text-sm opacity-80">Beautiful scheduling that converts visitors into customers.</p>
        {/* <a href="#pricing" className="inline-block mt-5 rounded-full bg-yellow-400 text-black font-semibold px-6 py-2"> */}
        <a href="https://resume.adople.ai/" className="inline-block mt-5 rounded-full bg-yellow-400 text-black font-semibold px-6 py-2">
          Get Lumical now
        </a>
      </div>
    </section>

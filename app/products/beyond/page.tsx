...
//   const product = products.find((p) => p.slug === "beyond")
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div>
          ...
          <h1 className="text-3xl md:text-5xl font-semibold text-pretty">
            AI‑powered insights for smarter crypto investments
          </h1>
          <p className="mt-4 text-sm md:text-base opacity-90 max-w-prose">
            AI‑powered insights for smarter crypto investments and automated research workflows. 
            Make data-driven decisions in the volatile crypto market.
          </p>
...
function TrustBar() {
  return (
    <div className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
      ...
      <span>4.6/5 from 31 reviews</span>
    </div>
  )
}
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div>
        <h2 className="text-2xl md:text-3xl font-semibold text-pretty">
          Data-driven crypto investment strategies
        </h2>
        <ul className="mt-6 space-y-4">
          <li className="border rounded-lg p-4">
            <details open>
              <summary className="font-medium cursor-pointer">AI market analysis</summary>
              <p className="mt-2 text-sm text-muted-foreground">
                Get real-time market insights and trend analysis powered by advanced AI algorithms.
              </p>
            </details>
          </li>
          <li className="border rounded-lg p-4">
            <details>
              <summary className="font-medium cursor-pointer">Portfolio optimization</summary>
              <ul className="mt-2 list-disc pl-5 text-sm text-muted-foreground space-y-1">
                <li>AI-driven portfolio rebalancing recommendations</li>
          ...
          <li className="border rounded-lg p-4">
            <details>
              <summary className="font-medium cursor-pointer">Automated research</summary>
              <p className="mt-2 text-sm text-muted-foreground">
                Automate your crypto research with AI that analyzes news, social sentiment, and market data.
              </p>
            </details>
          </li>
          <li className="border rounded-lg p-4">
            <details>
              <summary className="font-medium cursor-pointer">Trading signals</summary>
              <p className="mt-2 text-sm text-muted-foreground">
                Receive intelligent trading signals based on technical analysis and market patterns.
              </p>
            </details>
          </li>
        </ul>
...
function StoryBlock({ theme }: { theme: "dark" | "light" }) {
  return (
    <section className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-[280px,1fr] gap-8">
      ...
      >
        <div className="text-sm">Founded December 3, 2022</div>
        <div className="mt-3 text-sm">Singapore</div>
        <div className="mt-3 text-sm">Team size: 8–15</div>
      ...
      <article>
        <h3 className="text-xl md:text-2xl font-semibold mb-3">Democratizing crypto investment intelligence</h3>
        <p className="text-muted-foreground">
          Beyond was created to level the playing field in crypto investment by providing institutional-grade 
          AI tools to individual investors. Our platform combines advanced machine learning with real-time 
          market data to deliver actionable insights that help investors make smarter decisions. 
          With Slack integration, we keep you informed of market opportunities and portfolio changes in real-time.
        </p>
      </article>
    </section>
  )
...
function Testimonials({ theme }: { theme: "dark" | "light" }) {
  const items = [
    { title: "Portfolio increased by 300%", name: "Alex Thompson", date: "Jul 10, 2025" },
    { title: "Best crypto analysis tool", name: "Maria Rodriguez", date: "Jul 5, 2025" },
    { title: "AI signals are incredibly accurate", name: "James Chen", date: "Jun 30, 2025" },
    { title: "Research automation saves hours", name: "Sarah Kim", date: "Jan 15, 2025" },
    { title: "Risk assessment is spot-on", name: "David Wilson", date: "Feb 20, 2025" },
    { title: "Real-time alerts are game-changing", name: "Emma Davis", date: "Mar 5, 2025" },
  ]
  return (
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {items.map((t, i) => (
          ...
          >
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              {i % 2
                ? "The AI analysis has completely transformed my investment strategy and portfolio performance."
                : "I've been using Beyond for 6 months and the trading signals have been incredibly accurate."}
            </p>
...
function StoriesYoullLove({ theme }: { theme: "dark" | "light" }) {
  const items = [
    { title: "How AI is Revolutionizing Crypto Trading", date: "Jul 12, 2025" },
    { title: "NEW FEATURE — Advanced Portfolio Analytics", date: "Jul 8, 2025" },
    { title: "The Complete Guide to Crypto Risk Management", date: "Apr 2, 2025" },
  ]
  return (
    <section className="max-w-7xl mx-auto px-4 py-12">
...
function InsiderKnowledge({ theme }: { theme: "dark" | "light" }) {
  const faqs = [
    ...
    "Can I connect my existing portfolio?",
    "How do you ensure data security?",
    "What types of analysis do you provide?",
        ...
        <div className="mt-6 space-y-3">
          {faqs.map((q, i) => (
            ...
            >
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                {i % 2
                  ? "Our AI signals have shown 75% accuracy over the past year, but past performance doesn't guarantee future results."
                  : "We support all major cryptocurrencies including Bitcoin, Ethereum, and over 1000 altcoins."}
              </p>
            </details>
          ))}
        </div>
  ...
  return (
    <section className={cn("mt-6 py-14 text-center", theme === "dark" ? "bg-[#0a0d0b]" : "bg-neutral-950 text-white")}>
      <div className="max-w-3xl mx-auto px-4">
        <h3 className="text-xl md:text-2xl font-semibold">Start making smarter crypto investments</h3>
        <p className="mt-2 text-sm opacity-80">AI-powered insights for the modern crypto investor.</p>

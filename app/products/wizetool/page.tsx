...
//   const product = products.find((p) => p.slug === "wizetool")
...
export default function WizeToolPage() {
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div>
          ...
          <h1 className="text-3xl md:text-5xl font-semibold text-pretty">
            Automate WhatsApp campaigns that convert
          </h1>
          <p className="mt-4 text-sm md:text-base opacity-90 max-w-prose">
            Automate WhatsApp campaigns with templates, flows, and smart routing that scales. 
            Engage customers on the world's most popular messaging platform.
          </p>
...
function TrustBar() {
  return (
    <div className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
      ...
      <span>4.6/5 from 52 reviews</span>
    </div>
  )
}
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div>
        <h2 className="text-2xl md:text-3xl font-semibold text-pretty">
          WhatsApp automation that drives real results
        </h2>
        <ul className="mt-6 space-y-4">
          <li className="border rounded-lg p-4">
            <details open>
              <summary className="font-medium cursor-pointer">Message templates & flows</summary>
              <p className="mt-2 text-sm text-muted-foreground">
                Create engaging message templates and automated conversation flows that guide customers through your sales process.
              </p>
            </details>
          </li>
          <li className="border rounded-lg p-4">
            <details>
              <summary className="font-medium cursor-pointer">Smart routing & segmentation</summary>
              <ul className="mt-2 list-disc pl-5 text-sm text-muted-foreground space-y-1">
                <li>Route messages to the right team members</li>
                <li>Segment customers based on behavior and preferences</li>
          ...
          <li className="border rounded-lg p-4">
            <details>
              <summary className="font-medium cursor-pointer">Bulk messaging campaigns</summary>
              <p className="mt-2 text-sm text-muted-foreground">
                Send personalized messages to thousands of contacts with advanced scheduling and delivery tracking.
              </p>
            </details>
          </li>
          <li className="border rounded-lg p-4">
            <details>
              <summary className="font-medium cursor-pointer">Analytics & reporting</summary>
              <p className="mt-2 text-sm text-muted-foreground">
                Track message delivery, open rates, response times, and conversion metrics to optimize your campaigns.
              </p>
            </details>
          </li>
        </ul>
...
function renderFeatureValue(name: string, t: { price: number; credits: number }) {
  switch (name) {
    ...
    case "Messages per month":
      return t.credits === 0 ? 1000 : "Unlimited"
    case "Contact lists":
      return t.credits === 0 ? 500 : "Unlimited"
    case "Message templates":
      return t.credits === 0 ? 10 : t.credits >= 400 ? "Unlimited" : 50
    case "Automated flows":
...
function StoryBlock({ theme }: { theme: "dark" | "light" }) {
  return (
    <section className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-[280px,1fr] gap-8">
      ...
      >
        <div className="text-sm">Founded April 20, 2023</div>
        <div className="mt-3 text-sm">Berlin, Germany</div>
      ...
      <article>
        <h3 className="text-xl md:text-2xl font-semibold mb-3">Revolutionizing WhatsApp business communication</h3>
        <p className="text-muted-foreground">
          WizeTool was created to help businesses leverage the power of WhatsApp for customer engagement and sales. 
          With over 2 billion users worldwide, WhatsApp is the perfect platform for reaching customers where they are. 
          Our automation tools make it easy to scale personalized communication without losing the human touch. 
          With integrations to WhatsApp Business API and Zapier, we connect seamlessly with your existing workflow.
        </p>
      </article>
    </section>
  )
...
function Testimonials({ theme }: { theme: "dark" | "light" }) {
  const items = [
    { title: "Increased our response rate by 300%", name: "Carlos Mendez", date: "Jun 25, 2025" },
    { title: "Perfect for customer support", name: "Anna Kowalski", date: "Jun 20, 2025" },
    { title: "Automation saves us hours daily", name: "Raj Patel", date: "Jun 15, 2025" },
    { title: "Best WhatsApp tool we've used", name: "Sophie Martin", date: "Jan 30, 2025" },
    { title: "Templates are incredibly effective", name: "Lucas Silva", date: "Feb 10, 2025" },
    { title: "Analytics help us optimize campaigns", name: "Emma Wilson", date: "Feb 28, 2025" },
  ]
  return (
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {items.map((t, i) => (
          ...
          >
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              {i % 2
                ? "The automated flows guide customers perfectly through our sales process."
                : "We can now handle hundreds of customer inquiries simultaneously without hiring more staff."}
            </p>
...
function StoriesYoullLove({ theme }: { theme: "dark" | "light" }) {
  const items = [
    { title: "10 WhatsApp Marketing Strategies That Convert", date: "Jul 25, 2025" },
    { title: "NEW FEATURE — Advanced Flow Builder", date: "Jun 28, 2025" },
    { title: "The Complete Guide to WhatsApp Business API", date: "Apr 15, 2025" },
  ]
  return (
    <section className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="mt-6 space-y-3">
          {faqs.map((q, i) => (
            ...
            >
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                {i % 2
                  ? "Connect your WhatsApp Business account through our simple OAuth process in just a few clicks."
                  : "Yes, you can manage multiple WhatsApp numbers and route messages based on business logic."}
              </p>
            </details>
          ))}
        </div>
  ...
  return (
    <section className={cn("mt-6 py-14 text-center", theme === "dark" ? "bg-[#0a0d0b]" : "bg-neutral-950 text-white")}>
      <div className="max-w-3xl mx-auto px-4">
        <h3 className="text-xl md:text-2xl font-semibold">Start automating WhatsApp today</h3>
        <p className="mt-2 text-sm opacity-80">Engage customers on the world's most popular messaging platform.</p>
